...
CREATE TABLE `found_animals` (
  ...
  `priority` enum('Alta','Media','Baixa','Por classificar') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Por classificar',
...
-- Dump completed on 2020-12-21 22:40:00
