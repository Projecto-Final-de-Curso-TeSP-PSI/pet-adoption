...
<div class="site-index">
    ...
    <div class="logoImg">
        <?= Html::img('@web/images/Logol.png', ['alt' => 'Logo']); ?>
    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-30">
                        <div class="card-body">
                            ...
                            <a href="/pet-adoption/paws4adoption_web/frontend/web/site/faq" class="card-link">FAQ</a>
                            <a href="/pet-adoption/paws4adoption_web/frontend/web/site/help" class="card-link">Ajudar</a>
                        </div>
                    </div>
                </div>
