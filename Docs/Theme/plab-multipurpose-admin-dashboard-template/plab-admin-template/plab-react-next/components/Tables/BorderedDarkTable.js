...
class BorderedDarkTable extends Component {
    render() {
        return (
            <div className="card mb-30">
                <div className="card-body">
                    <div className="card-header">
                        <h5 className="card-title">Bordered Dark Table</h5>
                    </div>

                    <div className="table-responsive">
                        <table className="table m-0 text-center table-bordered table-dark">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Date</th>
...
export default BorderedDarkTable;