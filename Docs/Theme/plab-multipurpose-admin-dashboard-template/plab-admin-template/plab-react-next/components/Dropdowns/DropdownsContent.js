...
class DropdownsContent extends Component {
    render() {
        return (
            <React.Fragment>
                <Row>
                    <Col xl={12}>
                        ...
                        <div className="card mb-30">
                            <div className="card-body">
                                ...
                                <Dropdown className="d-inline-block mr-3 mt-2">
                        ...
                        <div className="card mb-30">
                            <div className="card-body todo-list">
                                ...
                                <Dropdown as={ButtonGroup} className="d-inline-block mr-3 mt-2">
                    ...
                    <Col xl={12}>
                        ...
                        <div className="card mb-30">
                            <div className="card-body">
                                ...
                                <ButtonToolbar className="d-inline-block mr-3 mt-2">
