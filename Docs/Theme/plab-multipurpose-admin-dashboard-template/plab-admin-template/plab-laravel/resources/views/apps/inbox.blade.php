...
@section('content-wrapper')
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="EmailOne" role="tabpanel">
                                    <div class="email-details-warp">
                                        <div class="d-flex">
                                            <img src="{{ asset('assets/images/user/1.jpg') }}" alt="User" class="wh-30 mr-2 rounded-circle">
                                            <div class="info">
                                ...
                                <div class="tab-pane fade" id="EmailTwo" role="tabpanel">
                                    <div class="email-details-warp">
                                        <div class="d-flex">
                                            <img src="{{ asset('assets/images/user/2.jpg') }}" alt="User" class="wh-30 mr-2 rounded-circle">
                                            <div class="info">
                                ...
                                <div class="tab-pane fade" id="EmailThree" role="tabpanel">
                                    <div class="email-details-warp">
                                        <div class="d-flex">
                                            <img src="{{ asset('assets/images/user/3.jpg') }}" alt="User" class="wh-30 mr-2 rounded-circle">
                                            <div class="info">
                                ...
                                <div class="tab-pane fade" id="EmailFour" role="tabpanel">
                                    <div class="email-details-warp">
                                        <div class="d-flex">
                                            <img src="{{ asset('assets/images/user/4.jpg') }}" alt="User" class="wh-30 mr-2 rounded-circle">
                                            <div class="info">
                                ...
                                <div class="tab-pane fade" id="EmailFive" role="tabpanel">
                                    <div class="email-details-warp">
                                        <div class="d-flex">
                                            <img src="{{ asset('assets/images/user/5.jpg') }}" alt="User" class="wh-30 mr-2 rounded-circle">
                                            <div class="info">
    ...
    <!-- Send Email Madal -->
    @include('apps.partials.send-email-madal')
