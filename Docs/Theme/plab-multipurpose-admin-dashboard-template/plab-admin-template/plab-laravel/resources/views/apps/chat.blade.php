                        ...
                        <div class="mail-item-nav">
                            ...
                            <div class="flex-column nav nav-pills" role="tablist">
                                <a class="nav-link active" data-toggle="pill" href="#chatOne">
                                    <img src="{{ asset('assets/images/user/1.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                ...
                                <a class="nav-link" data-toggle="pill" href="#chatTwo">
                                    <img src="{{ asset('assets/images/user/2.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                    <span class="status online"></span>
                                    <div class="info">
                                ...
                                <a class="nav-link" data-toggle="pill" href="#chatThree">
                                    <img src="{{ asset('assets/images/user/3.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                    <span class="status online"></span>
                                    <div class="info">
                                ...
                                <a class="nav-link" data-toggle="pill" href="#chatFour">
                                    <img src="{{ asset('assets/images/user/4.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                    <span class="status online"></span>
                                    <div class="info">
                                ...
                                <a class="nav-link" data-toggle="pill" href="#chatFive">
                                    <img src="{{ asset('assets/images/user/5.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                ...
                                <a class="nav-link" data-toggle="pill" href="#chatSix">
                                    <img src="{{ asset('assets/images/user/6.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                    <span class="status away"></span>
                                    <div class="info">
                                ...
                                <a class="nav-link" data-toggle="pill" href="#chatSeven">
                                    <img src="{{ asset('assets/images/user/7.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                ...
                                <a class="nav-link" data-toggle="pill" href="#chatEight">
                                    <img src="{{ asset('assets/images/user/8.jpg') }}" alt="User" class="wh-30 rounded-circle">
                                    <span class="status ofline"></span>
                                    <div class="info">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="chatOne" role="tabpanel">
                                <div class="email-details-warp chat-details-warp">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/user/1.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="info">
                                    ...
                                    <div class="chat-list-right">
                                        <img src="{{ asset('assets/images/user/1.jpg') }}" alt="User" class="wh-40 rounded-circle">
                                    ...
                                    <div class="chat-list-left">
                                        <img src="{{ asset('assets/images/user/2.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="chat-details">
                                            <div class="name">Marco Gomez</div>
                            ...
                            <div class="tab-pane fade" id="chatThree" role="tabpanel">
                                <div class="email-details-warp chat-details-warp">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/user/3.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="info">
                            ...
                            <div class="tab-pane fade" id="chatFour" role="tabpanel">
                                <div class="email-details-warp chat-details-warp">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/user/4.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="info">
                            ...
                            <div class="tab-pane fade" id="chatFive" role="tabpanel">
                                <div class="email-details-warp chat-details-warp">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/user/5.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="info">
                            ...
                            <div class="tab-pane fade" id="chatSix" role="tabpanel">
                                <div class="email-details-warp chat-details-warp">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/user/6.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="info">
                            ...
                            <div class="tab-pane fade" id="chatSeven" role="tabpanel">
                                <div class="email-details-warp chat-details-warp">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/user/7.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="info">
                                            <div class="name mt-2 fs-15">George Petty</div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="chatEihgt" role="tabpanel">
                                <div class="email-details-warp chat-details-warp">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/user/8.jpg') }}" alt="User" class="wh-40 mr-2 rounded-circle">
                                        <div class="info">
