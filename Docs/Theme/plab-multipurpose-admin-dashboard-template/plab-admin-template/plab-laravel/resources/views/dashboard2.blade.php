				...
				<div class="card-body">
					...
					<div class="new-customer">
						<a class="profile mr-3" href="#">
							<img src="{{ asset('assets/images/user/1.jpg') }}" alt="User" class="rounded-circle">
					...
					<div class="new-customer">
						<a class="profile mr-3" href="#">
							<img src="{{ asset('assets/images/user/2.jpg') }}" alt="User" class="rounded-circle">
							<span class="status online right-3 bottom"></span>
						</a>
						<h5 class="fs-13 m-0">
					...
					<div class="new-customer">
						<a class="profile mr-3" href="#">
							<img src="{{ asset('assets/images/user/3.jpg') }}" alt="User" class="rounded-circle">
							<span class="status online right-3 bottom"></span>
						</a>
						<h5 class="fs-13 m-0">
					...
					<div class="new-customer">
						<a class="profile mr-3" href="#">
							<img src="{{ asset('assets/images/user/4.jpg') }}" alt="User" class="rounded-circle">
							<span class="status online right-3 bottom"></span>
						</a>
						<h5 class="fs-13 m-0">
					...
					<div class="new-customer">
						<a class="profile mr-3" href="#">
							<img src="{{ asset('assets/images/user/5.jpg') }}" alt="User" class="rounded-circle">
					...
					<div class="new-customer">
						<a class="profile mr-3" href="#">
							<img src="{{ asset('assets/images/user/6.jpg') }}" alt="User" class="rounded-circle">
