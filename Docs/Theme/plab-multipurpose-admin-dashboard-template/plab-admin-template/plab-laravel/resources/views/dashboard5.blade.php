						...
						<table class="table table-hover text-vertical-middle mb-0">
							...
							<tbody>
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/projects/1.jpg') }}" alt="Image" class="wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/projects/2.jpg') }}" alt="Image" class="wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/projects/3.jpg') }}" alt="Image" class="wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/projects/4.jpg') }}" alt="Image" class="wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/projects/5.jpg') }}" alt="Image" class="wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/projects/6.jpg') }}" alt="Image" class="wh-30 mr-2">
						...
						<table class="table table-hover text-vertical-middle mb-0">
							...
							<tbody>
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/user/7.jpg') }}" alt="Image" class="rounded wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/user/6.jpg') }}" alt="Image" class="rounded wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/user/5.jpg') }}" alt="Image" class="rounded wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/user/4.jpg') }}" alt="Image" class="rounded wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/user/3.jpg') }}" alt="Image" class="rounded wh-30 mr-2">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/user/2.jpg') }}" alt="Image" class="rounded wh-30 mr-2">
						...
						<table class="table table-hover text-vertical-middle mb-0">
							...
							<tbody>
								<tr>
									<td>
										<div class="media align-items-center">
											<img src="{{ asset('assets/images/user/1.jpg') }}" alt="Image" class="rounded wh-30 mr-2">
											<strong>Colin Firth</strong>
										</div>
									</td>
									<td>UI/UX Design</td>
