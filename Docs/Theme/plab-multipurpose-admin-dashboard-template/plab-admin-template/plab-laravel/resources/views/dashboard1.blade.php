				...
				<div class="card-body">
					...
					<ul class="top-rated-products height-408">
						<li class="single-product">
							<a href="#">
								<img src="{{ asset('assets/images/product/product1.jpg') }}" alt="Image">
							</a>
						...
						<li class="single-product">
							<a href="#">
								<img src="{{ asset('assets/images/product/product2.jpg') }}" alt="Image">
							</a>
						...
						<li class="single-product">
							<a href="#">
								<img src="{{ asset('assets/images/product/product4.jpg') }}" alt="Shoes">
							</a>
						...
						<li class="single-product">
							<a href="#">
								<img src="{{ asset('assets/images/product/product5.jpg') }}" alt="Image">
							</a>
						...
						<li class="single-product">
							<a href="#">
								<img src="{{ asset('assets/images/product/product6.jpg') }}" alt="Image">
							</a>
						...
						<li class="single-product">
							<a href="#">
								<img src="{{ asset('assets/images/product/product7.jpg') }}" alt="Image">
							</a>
						...
						<div class="table-responsive">
							<table class="table m-0 text-vertical-middle">
								<tbody>
									<tr>
										<td>
											<img src="{{ asset('assets/images/user/1.jpg') }}" alt="avatar" class="wh-40 mr-1 rounded">
										</td>
										<td>
									...
									<tr>
										<td>
											<img src="{{ asset('assets/images/user/2.jpg') }}" alt="avatar" class="wh-40 mr-1 rounded">
										</td>
										<td>
									...
									<tr>
										<td>
											<img src="{{ asset('assets/images/user/3.jpg') }}" alt="avatar" class="wh-40 mr-1 rounded">
										</td>
										<td>
									...
									<tr>
										<td>
											<img src="{{ asset('assets/images/user/4.jpg') }}" alt="avatar" class="wh-40 mr-1 rounded">
										</td>
										<td>
									...
									<tr>
										<td>
											<img src="{{ asset('assets/images/user/5.jpg') }}" alt="avatar" class="wh-40 mr-1 rounded">
										</td>
										<td>
									...
									<tr>
										<td>
											<img src="{{ asset('assets/images/user/6.jpg') }}" alt="avatar" class="wh-40 mr-1 rounded">
										</td>
										<td>
									...
									<tr>
										<td>
											<img src="{{ asset('assets/images/user/7.jpg') }}" alt="avatar" class="wh-40 mr-1 rounded">
										</td>
										<td>
